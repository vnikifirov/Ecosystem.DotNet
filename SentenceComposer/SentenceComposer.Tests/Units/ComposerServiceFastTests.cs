...
{
    public class ComposerServiceFastTests
    {
        ...
        {
            var result = _composerService.CheckWordsFast(_baseString, targetString);
        ...
        {
            var result = _composerService.CheckWordsFast(_baseString, null);
        ...
        {
            var result = _composerService.CheckWordsFast(_baseString, Array.Empty<string>());
        ...
        {
            var result = _composerService.CheckWordsFast(Array.Empty<string>(), targetString);
        ...
        {
            var result = _composerService.CheckWordsFast(null, targetString);
